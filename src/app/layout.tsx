...
export const metadata: Metadata = {
  ...
  description:
    "Tortas artesanales en Tlalpan desde 1972. Tradición con sazón. Pide en línea y recoge en Tizimín 163, Lomas de Padierna, CDMX.",
  openGraph: {
    title: "Tortas Don Manuel — Desde 1972",
    description: "Tradición con sazón. Tortas artesanales en Tlalpan, CDMX.",
    locale: "es_MX",
    type: "website",
